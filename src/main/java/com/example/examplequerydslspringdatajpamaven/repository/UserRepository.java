...
public interface UserRepository extends JpaRepository<User, Long>, QueryDslPredicateExecutor<User> {
	...
	@Query(value = "SELECT id,name FROM tc_users " +
			" where id IN(:userIds) and delete_date is null",nativeQuery = true)
	public List<UserSelect> getUserSelectWithNewChild(@Param("userIds")List<Long> userIds);
